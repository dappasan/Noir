...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an ɪᴛsᴜᴋᴀ management bot [✨](https://telegra.ph/file/dbbb842f911facca0a83e.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="➗ ᴀᴅᴅ ɪᴛsᴜᴋᴀ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➗", url=f"t.me/{bu}?startgroup=new"),
    ],
]
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting www.xnxx.com \
...
def yins_about_callback(update, context):
    ...
    if query.data == "yins_":
        query.message.edit_text(
            text="๏ I'm *ɪᴛsᴜᴋᴀ*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_ɪᴛsᴜᴋᴀ licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for ɪᴛsᴜᴋᴀ.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
